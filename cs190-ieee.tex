...
\usepackage{cite,graphicx,float,listings,url,fancyhdr}

\fancypagestyle{IEEEoverride}{
  \fancyhf{}
  \fancyhead[L]{CMSC 170 Introduction to Artificial Intelligence, \ICS}
  \fancyhead[R]{\thepage}
  \fancyfoot[C]{\copyright~2006~ICS \UPLB}
  \renewcommand{\headrulewidth}{0pt}
  \renewcommand{\footrulewidth}{0pt}
}

\pagestyle{IEEEoverride}
